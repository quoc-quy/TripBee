  ...
  return (
    <div className="space-y-6 p-6 bg-slate-50 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h2 className="text-3xl font-bold tracking-tight text-slate-800">Dashboard Tổng quan</h2>
        </div>
        <Button
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="border-none shadow-md bg-gradient-to-br from-blue-500 to-blue-600 text-white">
          ...
          <CardContent>
            ...
            <p className="text-xs text-blue-100 mt-1 opacity-80">Đã thanh toán thành công</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-none shadow-md bg-gradient-to-br from-purple-500 to-purple-600 text-white">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-purple-100">Đơn Đặt Tour</CardTitle>
            <ShoppingBag className="h-4 w-4 text-purple-100" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{stats.totalBookings}</div>
            <p className="text-xs text-purple-100 mt-1 opacity-80">Tổng số booking toàn hệ thống</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-none shadow-md bg-gradient-to-br from-orange-400 to-orange-600 text-white">
          ...
          <CardContent>
            ...
            <p className="text-xs text-orange-100 mt-1 flex items-center gap-1 opacity-90">
              <TrendingUp className="h-3 w-3" /> +{stats.newUsersThisMonth} khách hàng mới tháng này
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="border-none shadow-md bg-gradient-to-br from-pink-500 to-rose-500 text-white">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-pink-100">Cần Xử Lý</CardTitle>
            <MessageSquareWarning className="h-4 w-4 text-pink-100" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{stats.pendingContactMessages}</div>
            <p className="text-xs text-pink-100 mt-1 opacity-80">Tin nhắn liên hệ chưa đọc</p>
          </CardContent>
        </Card>
      </div>
