        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 border-b border-gray-700 pb-10">
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold">TravelViet</span>
            </div>
            <p className="text-sm text-gray-400">
              Khám phá vẻ đẹp Việt Nam cùng chúng tôi. Chúng tôi cung cấp những
              tour du lịch chất lượng cao với dịch vụ tận tâm và giá cả hợp lý.
            </p>
