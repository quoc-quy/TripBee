...
const faqs = [
    {
        ...
        answer: "Quý khách có thể đặt tour trực tiếp trên website, qua điện thoại hoặc đến trực tiếp văn phòng của chúng tôi. Đội ngũ tư vấn sẽ hỗ trợ bạn chọn tour phù hợp nhất.",
    },
    {
        question: "Chính sách hủy tour như thế nào?",
        answer: "Chính sách hủy tour được linh hoạt: Hoàn tiền 100% nếu hủy trước 7 ngày, 50% nếu hủy trước 3 ngày, và 0% nếu hủy sau 3 ngày.",
    },
    {
        question: "Tour có bao gồm bảo hiểm không?",
        answer: "Tất cả tour của chúng tôi đều bao gồm bảo hiểm du lịch cơ bản. Khách hàng có thể mua thêm bảo hiểm mở rộng nếu có nhu cầu.",
    },
    {
        question: "Có thể tùy chỉnh lịch trình tour không?",
        answer: "Chúng tôi có các tour tùy chọn cho nhóm từ 6 người trở lên. Liên hệ với chúng tôi để được tư vấn chi tiết.",
    },
];
...
function GeneralContactInfo() {
    return (
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-center text-gray-700 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            />
            <ContactInfoCard icon={FaPhoneAlt} title="Điện thoại" detail="+84 901 234 567" />
            <ContactInfoCard icon={FaEnvelope} title="Email" detail="info@travelviet.com" />
            <ContactInfoCard icon={FaClock} title="Giờ làm việc" detail="T2-T7, 8:00 - 18:00" />
        </div>
    );
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
                ...
                <div className="bg-white p-4 rounded-xl shadow-lg">
                    <h2 className="text-xl font-bold text-gray-800 mb-4">Văn Phòng Chính</h2>
                ...
                <div className="bg-white p-8 rounded-xl shadow-lg">
                    ...
                    <div className="space-y-4">
                        {officeLocations
                            ...
                            .map((loc) => (
                                <div key={loc.city} className="border-l-4 border-orange-500 pl-3">
                                    <h3 className="font-semibold text-gray-800">{loc.city}</h3>
                                    <p className="text-sm text-gray-600">Địa chỉ: {loc.address}</p>
                                    <p className="text-sm text-gray-600">Điện thoại: {loc.phone}</p>
