...
export default function PaymentScreen() {
  ...
  const { data: bookingData, isLoading } = useQuery({
    ...
    refetchInterval: (query) => {
      ...
      if (status === 'CONFIRMED' || status === 'CANCELED' || isExpired) return false
      return 3000
    }
  })
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="bg-white p-8 rounded-2xl shadow-xl max-w-md w-full text-center">
          ...
          <p className="text-gray-600 mb-6">
            Thời gian thanh toán (3 phút) đã kết thúc. Đơn hàng <b>{id}</b> đã bị hủy tự động.
          </p>
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="bg-white p-8 rounded-2xl shadow-xl max-w-md w-full text-center">
          ...
          <p className="text-gray-600 mb-6">
            Cảm ơn bạn đã đặt tour. Mã đơn hàng <b>{booking.bookingID}</b> đã được xác nhận.
          </p>
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
              ...
              <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg text-center animate-pulse">
                <p className="text-red-700 font-medium mb-1">Vui lòng thanh toán trong vòng</p>
              ...
              <div className="bg-blue-50 p-4 rounded-lg border border-blue-100 mb-6">
                <div className="flex justify-between mb-2">
                  ...
                  <span className="font-mono font-bold text-blue-700">{booking.bookingID}</span>
                </div>
              ...
              <h3 className="font-semibold text-gray-800 border-b pb-2 mb-3">Chi tiết dịch vụ</h3>
                ...
                <div className="w-full bg-gray-50 p-3 rounded-lg text-sm space-y-2 border border-dashed border-gray-300">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center">
                      <span className="font-medium mr-2">{MY_ACCOUNT_NO}</span>
                      <Copy
                        size={14}
                        className="cursor-pointer text-blue-500 hover:text-blue-700"
                        onClick={() => navigator.clipboard.writeText(MY_ACCOUNT_NO)}
                      />
                    </div>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-500">Nội dung:</span>
                    <span className="font-bold text-red-600">{transferContent}</span>
                  </div>
                </div>
                <div className="mt-6 w-full text-center">
                  <div className="flex items-center justify-center text-xs text-blue-600">
                    <Loader2 className="animate-spin mr-1" size={14} /> Đang chờ xác nhận thanh
                    toán...
                  </div>
                </div>
              </div>
